...
public class Tela2 extends javax.swing.JFrame {
    ...
    public Tela2() {
        ...
        String idioma = this.configuracao.getIdioma();
        String nomeAplicacao = this.configuracao.getNomeAplicacao();
        int tamanho = this.configuracao.getTamanhoMaximo();
        this.jTextArea1.setText(idioma+"\n" + nomeAplicacao + "\n"+ tamanho);
    }
